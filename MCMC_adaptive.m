...
function [xsto, outsto, history, accept_rate] = MCMC_adaptive(F, x0, n, sigma, fixinds, blockind, displ, cov01)
...
cov01(inds,:) = 0; cov01(:,inds) = 0;
cov01(1:blockind,blockind+1:end) = 0; cov01(blockind+1:end,1:blockind) = 0;
...
for t = 2:n
    ...
    Y0 = mvnrnd(X,0.1^2*cov01*sigma/d);
    if t < 2*d
